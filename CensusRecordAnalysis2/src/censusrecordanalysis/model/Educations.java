...
@NamedQueries({
    ...
    @NamedQuery(name = "Educations.findById", query = "SELECT e FROM Educations e WHERE e.id = :id"),
    @NamedQuery(name = "Educations.findByEducationTitle", query = "SELECT e FROM Educations e WHERE e.educationTitle = :educationTitle")})
public class Educations implements Serializable {
    ...
    public String toString() {
        return "censusrecordanalysis.model.Educations[ id=" + id + " ]";
    }
